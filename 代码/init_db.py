...
def seed_data():
    ...
    products = [
        ("alice", "数码电子", "iPhone 13 128G 蓝色",
         ...
         "https://picsum.photos/seed/iphone13/600/450"),
        ("alice", "图书教材", "《数据库系统概论》第5版",
         "王珊著，考研专业课用书，少量笔记，不影响阅读。", 25.00, "9成新",
         "https://picsum.photos/seed/dbbook/600/450"),
        ("bob", "数码电子", "罗技 MX Master 3 鼠标",
         "办公神器，手感极佳，含 USB 接收器。", 320.00, "95新",
         "https://picsum.photos/seed/mxmaster/600/450"),
        ("bob", "运动户外", "迪卡侬 折叠自行车",
         "通勤代步，已骑半年，刹车变速正常。", 480.00, "8成新",
         "https://picsum.photos/seed/bike/600/450"),
        ("carol", "服饰鞋包", "Nike Air Force 1 白色 42码",
         "正品，穿过两次，鞋盒齐全。", 350.00, "99新",
         "https://picsum.photos/seed/af1/600/450"),
        ("carol", "生活家居", "宜家台灯 暖光",
         "护眼台灯，三档亮度，搬家出。", 45.00, "9成新",
         "https://picsum.photos/seed/lamp/600/450"),
    ]
